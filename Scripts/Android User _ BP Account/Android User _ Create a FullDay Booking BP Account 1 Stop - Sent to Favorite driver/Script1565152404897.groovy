...
Mobile.tap(findTestObject('Android User _ Sent to Favorite driver/android.widget.TextView9 - Favorite'), 0)
...
not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/btnImageButton0'), 0)

not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/btn1 - Yes'), 0)

not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/imgImageView2'), 0)
...
not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.TextView1 - Take Photo'), 0)

not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/android.view.View4'), 0)

not_run: Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.ImageView1'), 0)
