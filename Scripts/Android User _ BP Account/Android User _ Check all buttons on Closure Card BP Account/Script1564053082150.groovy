...
Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.ImageView4 (1)Special Help'), 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/imgImageView4'), 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.TextView2 - 234 ng 3 Thng 2 Phng 12 District 10 Ho Chi Minh City Vietnam'), 
    0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/chkCheckBox0 - Document Return'), 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txt0 - Note'), 'testa', 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/chkCheckBox1 - Cash on Delivery'), 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txtEditText1 - Note'), 'notea', 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txt2 - Amount'), '1', 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/chkCheckBox2 - Document Return'), 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txt3 - Note'), 'noteb', 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/chkCheckBox3 - Cash on Delivery'), 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txt4 - Note'), 'notec', 0)

Mobile.setText(findTestObject('Android User _ Page 2 Services/txt5 - Amount'), '2', 0)

Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.Button2 - Confirm'), 0)

Mobile.swipe(200, 500, 200, 100)

Mobile.tap(findTestObject('Android User _ Page 2 Services/android.widget.CheckBox1 TIEN NEW BADGE'), 0)
...
not_run: Mobile.tap(findTestObject('Android User _ Page 3 Price/android.widget.ImageView6 Add me'), 0)

Mobile.swipe(200, 1500, 200, 100)

not_run: Mobile.tap(findTestObject('Android User _ Page 3 Price/android.widget.TextView10 - Add me'), 0)

Mobile.setText(findTestObject('Android User _ Page 3 Price/android.widget.EditText2 -  Recipient name'), 'test user', 0)

Mobile.swipe(200, 1500, 200, 100)

Mobile.setText(findTestObject('Android User _ Page 3 Price/android.widget.EditText3 -  Phone number'), '0909654789', 0)
...
Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.ImageButton0'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView22 - My Bookings'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.ImageView3'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView19 - Price'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Price'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.RelativeLayout0'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.ImageView1'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.RelativeLayout0'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView18 - INVOICED - NO CASH'), 
    0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView20 - Addresses'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Addresses'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.RelativeLayout0'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView21 - Signatures'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Signatures'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView22 - Customer Note'), 
    0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Customer Note'), 
    0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView23 - Customer Uploads'), 
    0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Customer Uploads'), 
    0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView24 - DocCOD'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Document Return or COD'), 
    0)
...
Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView25 - Driver Note'), 0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Driver Note'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView26 - Driver Uploads'), 
    0)

Mobile.tap(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView0 - Driver Uploads'), 
    0)

Mobile.pressBack()

if (Mobile.verifyElementExist(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView18 - Live Map (1)'), 
    1)) {
    Mobile.comment('Button Live Map Exist')
}

if (Mobile.verifyElementExist(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView21 - Save'), 
    1)) {
    Mobile.comment('Button Save Exist')
}

if (Mobile.verifyElementExist(findTestObject('Android User _ Check all buttons on Closure Card/android.widget.TextView20 - Duplicate'), 
    1)) {
    Mobile.comment('Button Duplicate Exist')
}
