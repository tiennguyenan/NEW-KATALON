...
Mobile.tap(findTestObject('Android User _ Cancel Booking/android.widget.TextView2 - Cancel  Save'), 0)

Mobile.tap(findTestObject('Android User _ Cancel Booking/android.widget.Button1 - Yes'), 0)

Mobile.tap(findTestObject('Android User _ Cancel Booking/android.widget.TextView1 - BeforeAll Customers - Used another provider'), 
    0)

Mobile.tap(findTestObject('Android User _ Cancel Booking/android.widget.TextView0 - Your booking is now cancelled.'), 0)
