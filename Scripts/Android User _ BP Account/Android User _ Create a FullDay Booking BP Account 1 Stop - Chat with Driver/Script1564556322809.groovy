...
Mobile.tap(findTestObject('Android User _ Chat with Driver/android.widget.TextView0 - Meet Your Driver'), 0)

Mobile.waitForElementPresent(findTestObject('Android User _ Chat with Driver/android.widget.ImageView6'), 20)

Mobile.tap(findTestObject('Android User _ Chat with Driver/android.widget.ImageView6'), 0)

Mobile.tap(findTestObject('Android User _ Chat with Driver/android.widget.ImageView0'), 0)

Mobile.setText(findTestObject('Android User _ Chat with Driver/android.widget.EditText0 - Type message'), 'hello driver', 
    0)

Mobile.tap(findTestObject('Android User _ Chat with Driver/android.widget.ImageButton1'), 0)
