...
Mobile.tap(findTestObject('Long Haul BP Account/android.widget.TextView9 - Long Haulhi'), 0)

Mobile.tap(findTestObject('Android User _ Page 1 Route/Android User _ Page 1 Route _ Schedule Booking/lblView30 - 30'), 
    0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.Button1 - OK'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.Button1 - OK (1)'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.TextView4 -  Input address or drop pin'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.ImageView2'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.ImageView0'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.TextView2 - Hue'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.Button1 - Confirm'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.HorizontalScrollView0'), 0)

Mobile.setText(findTestObject('Long Haul BP Account/android.widget.EditText0 -  Input Address'), 'bui san', 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.TextView5 - Bi San Thnh ph Hu Thua Thien Hue Vietnam'), 0)

sleep(2000)

try {
    if (Mobile.verifyElementExist(findTestObject('Long Haul BP Account/android.widget.Button1 - SET DESTINATION'), 1)) {
        Mobile.tap(findTestObject('Long Haul BP Account/android.widget.Button1 - SET DESTINATION'), 0)

        Mobile.tap(findTestObject('Long Haul BP Account/android.widget.Button0 - Next'), 0)
    }
}
catch (Exception ex) {
...
try {
    if (Mobile.verifyElementExist(findTestObject('Long Haul BP Account/android.widget.TextView0 - Select Destination'), 
        1)) {
        Mobile.tap(findTestObject('Long Haul Non BP Account/android.widget.Button0'), 0)
...
Mobile.tap(findTestObject('Long Haul BP Account/android.widget.ImageView3'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.CheckBox0'), 0)
...
Mobile.tap(findTestObject('Long Haul BP Account/android.widget.ImageView8 (1)'), 0)

Mobile.tap(findTestObject('Long Haul BP Account/android.widget.ImageView0 (2)'), 0)
