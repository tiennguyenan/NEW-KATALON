...
Mobile.tap(findTestObject('Long Haul Non BP Account/android.widget.ImageView7'), 0)

Mobile.tap(findTestObject('Long Haul Non BP Account/android.widget.ImageView0'), 0)
