...
not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnHamburger'), 
    0)

not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnLoginOrSignup'), 
    0)

not_run: Mobile.setText(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/txtPhoneOrEmail'), 
    'tien.nguyen@inspireventures.com', 0)

not_run: Mobile.setText(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/txtPassword'), 
    '123456abc', 0)

not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnSignIn'), 
    0)

not_run: Mobile.tap(findTestObject('Android User _ Page Login/txtTextView0 - Personal'), 0)

not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnOK'), 
    0)

not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/android.widget.TextView14 - BMW i8'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnTIENLEXUSTEST'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btnSelect Time'), 
    0)

not_run: Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/android.widget.TextView1 - Immediate 5min'), 0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/btn Immediate 45min'), 
    0)
