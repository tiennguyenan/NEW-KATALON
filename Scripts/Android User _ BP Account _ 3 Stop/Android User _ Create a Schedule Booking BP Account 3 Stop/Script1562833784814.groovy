...
Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/txt0 - Select Photo or File'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/btnImageButton0 (1)'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/txt23 - Photos'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/view.View0'), 
    0)

Mobile.tap(findTestObject('Android User _ BP Account _ 3 Stop/Android User _ Create an Immediate Booking 3 Stop/Android User Immediate BP Booking 3 Stop _ Step 2 Step 3/android.view.ViewGroup2'), 
    0)
