...
not_run: Mobile.tap(findTestObject('Android User _ Sign In/Android User _ Sign in successfully when using existing account/rdioCustomerType'), 
    0)
...
not_run: Mobile.tap(findTestObject('Android User _ Sign In/Sign In Function/android.widget.ImageView0'), 0)

not_run: Mobile.tap(findTestObject('Android User _ Sign In/Sign In Function/android.widget.TextView2 - Nguyen Thai Binh District 1 Ho Chi Minh City Vietnam'), 
    0)

not_run: Mobile.tap(findTestObject('Android User _ Sign In/Sign In Function/android.widget.Button1 - SET PICKUP'), 0)
