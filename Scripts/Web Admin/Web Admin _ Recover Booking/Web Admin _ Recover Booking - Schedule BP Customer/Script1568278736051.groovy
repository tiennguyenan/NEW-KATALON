...
WebUI.callTestCase(findTestCase('Web Admin/Web Admin Sign In/Web Admin Sign In BP Account'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Web Admin/Web Admin _ Sign In/Web Admin _ Schedule Booking/Page_Deliveree/div_RightSchedule'))
...
WebUI.click(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/div_Locating driver'))

WebUI.click(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/div_Canceled'))

WebUI.click(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/label_BeforeSME - Changed my mind'))
...
WebUI.setText(findTestObject('Web Admin/Web Admin _ Sign In/Page_Deliveree/Page_Deliveree/input_)_bookinglocations_attributes0name'), 
    'Lê Thị Hồng Gấm, District 1, Ho Chi Minh City, Vietnam')

WebUI.setText(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/input_)_bookinglocations_attributes0latitude'), 
    '10.7688999')

WebUI.setText(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/input_)_bookinglocations_attributes0longitude'), 
    '106.6975936')
...
WebUI.click(findTestObject('Web Admin/Web Admin _ Recover Booking/Page_Deliveree/a_Recover'))
